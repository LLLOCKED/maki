...
export default function LoginPage() {
  ...
  useEffect(() => {
    if (searchParams.get('verified') === 'true') {
      toast.success('Email підтверджено! Тепер ви можете увійти.')
    }
  }, [searchParams])
  ...
  return (
    <div
      ...
      style={{ backgroundImage: 'url(/static/images/login.png)', backgroundSize: 'cover', backgroundPosition: 'center', backdropFilter: 'blur(8px)' }}
    >
